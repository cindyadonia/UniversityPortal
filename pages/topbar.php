...
<ul class="navbar-nav ml-auto">
  ...
  <li class="nav-item dropdown no-arrow">
    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $yg_login;?></span>
      <?php if($gender=='Female')
      {
          ?> <img class="img-profile rounded-circle" src="../assets/img/female.jpg"> <?php
      }
      else if($gender == 'Male')
      {
          ?> <img class="img-profile rounded-circle" src="../assets/img/male.jpg"> <?php
      }
      ?>
    </a>
